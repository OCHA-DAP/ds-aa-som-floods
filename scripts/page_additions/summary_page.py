...
_mods = "".join(f'<th class="n">{NICE[m]}</th>' for m in ("google_grrr", "glofas_v5", "glofas_v4"))
add("<div class='tw'><table><thead>"
    "<tr><th></th><th colspan='3' class='n' style='border-bottom:1px solid var(--rule)'>Ranks the flood seasons as the gauges did</th>"
    "<th colspan='3' class='n' style='border-bottom:1px solid var(--rule)'>1-in-3 flood seasons caught at the window's rule</th><th></th></tr>"
