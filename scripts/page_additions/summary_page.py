...
for season in ("deyr", "gu"):
    ...
    # Deyr 2020 is not shown: the Shabelle window does not activate that season on its design
    # record at 1-in-5 (the GloFAS v4 replay meets the rule one day after the second gauge crossed)
    if season == "deyr":
