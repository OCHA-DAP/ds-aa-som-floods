...
<div class="wrap">
  ...
  <article>
    ...
    <ul>
      <li><strong>Dollow has no live Google gauge.</strong> The Flood Hub API serves six of the seven HYBAS gauges; Dollow's
          (<code>hybas_1121038740</code>) returns not-found, although it exists in the retrospective archive the Gu levels
          were fitted on. In Gu the Juba rule (3 of 4 points) can therefore only be met when all three live Juba points
          cross. A neighbouring live HYBAS gauge (<code>hybas_1121039440</code>, 8 km east-south-east of Dollow, modelled)
          is a candidate substitute if its retrospective matches Dollow's; that check has not been done.</li>
